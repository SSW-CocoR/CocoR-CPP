...
void Scanner::Init() {
	...
	for (i = 98; i <= 122; ++i) start.set(i, 9);
	for (i = 48; i <= 57; ++i) start.set(i, 10);
	start.set(97, 15);
		start.set(Buffer::EoF, -1);
	keywords.set(L"nul", 5);
	keywords.set(L"ab0c", 6);
	keywords.set(L"abc", 7);
	keywords.set(L"a", 9);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 4:
			...
			if ((ch >= '0' && ch <= '9')) {AddCh(); goto case_4;}
			else if (ch == 'E') {AddCh(); goto case_5;}
			else {t->kind = 4; break;}
		case 5:
			case_5:
			if ((ch >= '0' && ch <= '9')) {AddCh(); goto case_7;}
			else if (ch == '+' || ch == '-') {AddCh(); goto case_6;}
			else {goto case_0;}
		case 6:
			case_6:
			if ((ch >= '0' && ch <= '9')) {AddCh(); goto case_7;}
		...
		case 9:
			recEnd = pos; recKind = 1;
			if ((ch >= '0' && ch <= '9') || (ch >= 'A' && ch <= 'Z') || (ch >= 'a' && ch <= 'z')) {apx = 0; AddCh(); goto case_1;}
			else if (ch == '*') {apx = 0; AddCh(); goto case_2;}
			else if (ch == '_') {apx++; AddCh(); goto case_11;}
			else if (ch == '+') {apx++; AddCh(); goto case_3;}
			else {t->kind = 1; wchar_t *literal = coco_string_create(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 10:
			case_10:
			recEnd = pos; recKind = 4;
			if ((ch >= '0' && ch <= '9')) {AddCh(); goto case_10;}
			else if (ch == '.') {apx++; AddCh(); goto case_12;}
			else {t->kind = 4; break;}
		case 11:
			case_11:
			if (ch == '*') {apx = 0; AddCh(); goto case_2;}
			else if (ch == '_') {apx++; AddCh(); goto case_11;}
			else if (ch == '+') {apx++; AddCh(); goto case_3;}
			else {goto case_0;}
		case 12:
			case_12:
			recEnd = pos; recKind = 4;
			if ((ch >= '0' && ch <= '9')) {apx = 0; AddCh(); goto case_4;}
			else if (ch == 'E') {apx = 0; AddCh(); goto case_5;}
			else if (ch == '.') {apx++; AddCh(); goto case_8;}
			else {t->kind = 4; break;}
		case 13:
			case_13:
			{t->kind = 8; break;}
		...
		case 15:
			recEnd = pos; recKind = 1;
			if ((ch >= '0' && ch <= '9') || (ch >= 'A' && ch <= 'Z') || ch == 'a' || (ch >= 'c' && ch <= 'z')) {apx = 0; AddCh(); goto case_1;}
			else if (ch == '*') {apx = 0; AddCh(); goto case_2;}
			else if (ch == '_') {apx++; AddCh(); goto case_16;}
			else if (ch == '+') {apx++; AddCh(); goto case_3;}
			else if (ch == 'b') {apx = 0; AddCh(); goto case_17;}
			else {t->kind = 1; wchar_t *literal = coco_string_create(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 16:
			case_16:
			recEnd = pos; recKind = 10;
			if (ch == '*') {apx = 0; AddCh(); goto case_2;}
			else if (ch == '_') {apx++; AddCh(); goto case_18;}
			else if (ch == '+') {apx++; AddCh(); goto case_3;}
			else {t->kind = 10; break;}
		case 17:
			case_17:
			recEnd = pos; recKind = 1;
			if ((ch >= '0' && ch <= '9') || (ch >= 'A' && ch <= 'Z') || (ch >= 'a' && ch <= 'b') || (ch >= 'd' && ch <= 'z')) {AddCh(); goto case_1;}
			else if (ch == 'c') {AddCh(); goto case_19;}
			else {t->kind = 1; wchar_t *literal = coco_string_create(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 18:
			case_18:
			if (ch == '*') {apx = 0; AddCh(); goto case_20;}
			else if (ch == '_') {apx++; AddCh(); goto case_11;}
			else if (ch == '+') {apx++; AddCh(); goto case_3;}
			else {goto case_0;}
		case 19:
