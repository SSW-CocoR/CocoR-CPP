...
void Errors::SynErr(int line, int col, int n) {
	...
	switch (n) {
			...
			case 12: s = _SC("invalid A"); break;
			case 13: s = _SC("invalid B"); break;
			case 14: s = _SC("invalid B"); break;
			case 15: s = _SC("invalid C"); break;
			case 16: s = _SC("invalid D"); break;
