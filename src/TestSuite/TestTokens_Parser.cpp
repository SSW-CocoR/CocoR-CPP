...
void Errors::SynErr(int line, int col, int n) {
	...
	switch (n) {
			...
			case 2: s = _SC("ident1 expected"); break;
			case 3: s = _SC("ident2 expected"); break;
			case 4: s = _SC("number expected"); break;
			case 5: s = _SC("nul expected"); break;
			case 6: s = _SC("hasNul expected"); break;
			case 7: s = _SC("\"abc\" expected"); break;
			case 8: s = _SC("\"abc+\" expected"); break;
			case 9: s = _SC("\"a\" expected"); break;
			case 10: s = _SC("\"a_\" expected"); break;
			case 11: s = _SC("\"a__**\" expected"); break;
			case 12: s = _SC("??? expected"); break;
