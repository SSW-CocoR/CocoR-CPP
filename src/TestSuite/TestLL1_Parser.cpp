...
void Parser::A_NT() {
	...
	AstAddTerminal();
#endif
		} else if (IsKind(la, _a) || IsKind(la, _b) || IsKind(la, _c)) {
			B_NT();
		} else SynErr(11);
#ifdef PARSER_WITH_AST
...
void Parser::E_NT() {
#ifdef PARSER_WITH_AST
		bool ntAdded = AstAddNonTerminal(eNonTerminals::_E, _SC("E"), la->line);
#endif
		if (IsKind(la, _e) || IsKind(la, _f)) {
			F_NT();
		} else if (IsKind(la, _e)) {
		} else SynErr(12);
		Expect(_e);
#ifdef PARSER_WITH_AST
	AstAddTerminal();
...
void Parser::G_NT() {
#ifdef PARSER_WITH_AST
		bool ntAdded = AstAddNonTerminal(eNonTerminals::_G, _SC("G"), la->line);
#endif
		if (IsKind(la, _a) || IsKind(la, _b)) {
			if (eee) {
				if (IsKind(la, _a)) {
					Get();
#ifdef PARSER_WITH_AST
...
void Parser::H_NT() {
#ifdef PARSER_WITH_AST
		bool ntAdded = AstAddNonTerminal(eNonTerminals::_H, _SC("H"), la->line);
#endif
		if (IsKind(la, _a)) {
			Get();
#ifdef PARSER_WITH_AST
...
void Parser::I_NT() {
#ifdef PARSER_WITH_AST
		bool ntAdded = AstAddNonTerminal(eNonTerminals::_I, _SC("I"), la->line);
#endif
		while (IsKind(la, _a)) {
			Get();
#ifdef PARSER_WITH_AST
...
void Parser::J_NT() {
#ifdef PARSER_WITH_AST
		bool ntAdded = AstAddNonTerminal(eNonTerminals::_J, _SC("J"), la->line);
#endif
		while (aaa) {
			Expect(_a);
#ifdef PARSER_WITH_AST
	AstAddTerminal();
		...
		while (IsKind(la, _a) || IsKind(la, _b)) {
			if (eee) {
				if (IsKind(la, _a)) {
					Get();
#ifdef PARSER_WITH_AST
...
void Parser::F_NT() {
#ifdef PARSER_WITH_AST
		bool ntAdded = AstAddNonTerminal(eNonTerminals::_F, _SC("F"), la->line);
#endif
		if (IsKind(la, _f)) {
			Get();
#ifdef PARSER_WITH_AST
...
void Errors::SynErr(int line, int col, int n) {
	...
	switch (n) {
			...
			case 1: s = _SC("a expected"); break;
			case 2: s = _SC("b expected"); break;
			case 3: s = _SC("c expected"); break;
			case 4: s = _SC("d expected"); break;
			case 5: s = _SC("e expected"); break;
			case 6: s = _SC("f expected"); break;
			case 7: s = _SC("g expected"); break;
			case 8: s = _SC("h expected"); break;
			case 9: s = _SC("i expected"); break;
			case 10: s = _SC("??? expected"); break;
			case 11: s = _SC("invalid A"); break;
			case 12: s = _SC("invalid E"); break;
			case 13: s = _SC("invalid G"); break;
			case 14: s = _SC("invalid I"); break;
			case 15: s = _SC("invalid I"); break;
			case 16: s = _SC("invalid J"); break;
			case 17: s = _SC("invalid B"); break;
