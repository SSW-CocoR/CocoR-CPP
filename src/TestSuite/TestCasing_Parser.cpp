...
void Errors::SynErr(int line, int col, int n) {
	...
	switch (n) {
			...
			case 2: s = _SC("float1 expected"); break;
			case 3: s = _SC("float2 expected"); break;
			case 4: s = _SC("A expected"); break;
			case 5: s = _SC("\"bbb\" expected"); break;
			case 6: s = _SC("??? expected"); break;
