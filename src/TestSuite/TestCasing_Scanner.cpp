...
void Scanner::Init() {
	...
	keywords.set(_SC("aaa"), 4);
	keywords.set(_SC("bbb"), 5);
...
Token* Scanner::NextToken() {
	...
	tlen = 0; AddCh();
		...
		case 1:
			...
			if ((ch >= _SC('a') && ch <= _SC('z'))) {AddCh(); goto case_1;}
			else {t->kind = 1 /* ident */; t->kind = keywords.get(tval, tlen, t->kind, true); break;}
		case 2:
			case_2:
			{t->kind = 2 /* float1 */;  break;}
		case 3:
			case_3:
		...
		case 4:
			case_4:
			recEnd = pos; recKind = 3 /* float2 */;
			if ((ch >= _SC('0') && ch <= _SC('9'))) {AddCh(); goto case_4;}
			else {t->kind = 3 /* float2 */;  break;}
		case 5:
			case_5:
			if (ch == _SC('f')) {AddCh(); goto case_2;}
			else if ((ch >= _SC('0') && ch <= _SC('9'))) {AddCh(); goto case_5;}
			else if (ch == _SC('e')) {AddCh(); goto case_3;}
			else {goto case_0;}
